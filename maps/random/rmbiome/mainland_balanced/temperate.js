function setupBiome_temperate()
{
	...
	[g_Gaia.tree1, g_Gaia.tree2] = pickRandom([
		["gaia/tree/oak", "gaia/tree/oak_hungarian"],
		["gaia/tree/oak_holly", "gaia/tree/maple"],
		["gaia/tree/oak_hungarian", "gaia/tree/oak_holly"],
	]);

	[g_Gaia.tree4, g_Gaia.tree5] = pickRandom([
		["gaia/tree/pine", "gaia/tree/pine_maritime"],
		["gaia/tree/pine", "gaia/tree/pine"],
		["gaia/tree/pine_maritime", "gaia/tree/pine_maritime"],
	]);
}
